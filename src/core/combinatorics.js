...
// Order of the hyperoctahedral group B_n, the full symmetry group of the
// n-cube: 2^n sign flips times n! axis permutations (384 for the tesseract).
// Generated by the axis mirrors and the quarter-turns in coordinate planes.
export function symmetryOrder(n) {
  let factorial = 1;
  for (let i = 2; i <= n; i++) factorial *= i;
  return 2 ** n * factorial;
}
